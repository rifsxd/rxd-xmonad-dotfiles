...
myKeys conf@(XConfig {XMonad.modMask = super}) = M.fromList $
  ...
  -- launch applications
    ...
    , ((super,               xK_p), withFocused minimizeWindow)
    , ((super .|. shiftMask, xK_p), withLastMinimized maximizeWindowAndFocus)
  ...
  -- Window Manager Specific -----------------------------------------
    ...
    , ((super .|. shiftMask,   xK_j), windows W.swapUp)
...
defaults = def {
 ...
 manageHook = myManageHook,
        layoutHook = gaps [(L,0), (R,0), (U,0), (D,0)] $ spacingRaw False (Border 10 0 10 0) True (Border 0 10 0 10) True $ minimize . BW.boringWindows $ myLayout,
